...
const linking = {
  ...
  const secondLinking = {
    ...
    config: {
      screens: {
        MainLoginScreen: 'deepLink', // Path to match in the deep link
      },
    },
  };
// else {
...
//         config: {
//           screens: {
//             LoginUserScreen: 'deepLink', // Path to match in the deep link
//           },
//         },
//       };
// }
...
export default function  AppNavigator() {
   ...
   const initApp = async () => {
    const userName = await asyncStorage.getName();
    setName(userName);
    // const mobileNumber = await asyncStorage.getMobile();
   ...
   useEffect(() => {
    ...
    // console.log(asyncStorage.getName(),"This is usernmae in app navigator");
    console.log(name,"This is usernmae in app navigator");
    // console.log(userName,"This is usernmae in app navigator");
  return (
    <>
    {name !=null ? <><NavigationContainer linking={linking}>
    ...
    </NavigationContainer></> : <><NavigationContainer linking={secondLinking}>
    <Stack.Navigator initialRouteName="Splash">
        <Stack.Screen
            component={Splash}
            name="splash"
